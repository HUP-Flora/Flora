...
import { RisModalShowState } from "../../recoil/reservation";

function ReservationWarningModal({text}) {
	const setRisModalShow = useSetRecoilState(RisModalShowState);

	return (
		<>
			{PortalReactDom.createPortal(
				<Backdrop onClick={() => setRisModalShow(false)} />,
